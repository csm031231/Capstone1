...
const BottomSheet = ({ selectedTab = '재난문자' }) => {
    ...
    <>
      <Animated.View style={[styles.bottomSheet, animatedStyle]}>
        ...
        <View style={styles.listContainer}>
          ...
          <TouchableOpacity style={styles.addToListButton} onPress={handleViewAll}>
          ...
          {tabConfig.items.map((item, index) => (
            <View key={index} style={styles.listItem}>
              ...
              <TouchableOpacity style={styles.listItemMenu} onPress={handleListItemMenu}>
